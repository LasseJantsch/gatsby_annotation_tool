...
const TableEntry = ({id,status,count}) => {
        ...
        <div className="table_entry_container" key={id}>
            <div className="table_entry_content">
                ...
                <div className="entry_status entry_label">
                    {status === 'annotaded' && <div className="entry_status_icon_container" style={{backgroundColor:'green', color:'white'}}><CheckIcon className="entry_status_icon"/></div>}
