...
const Header = ({title, show_menu = true, unsaved_changes = true}) => {
        ...
        <div className="header">
            ...
            <div className="menu_card_container">
                <div className="menue_card_item_container">
                   <Link to='/'><button id='menu_card_item_1' className="menu_card_item">Overview</button></Link>
                </div>
                <div className="menue_card_item_container">
                    <Link to='/annotation'><button id='menu_card_item_2' className="menu_card_item">Guidelines</button></Link>
                </div>
            </div>
